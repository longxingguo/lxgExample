//
//  LXGCollectionViewHorizontalLayout.m
//  fzweather
//
...
@interface LXGCollectionViewHorizontalLayout ()
// 存放全部item布局信息的数组
...
@end
@implementation LXGCollectionViewHorizontalLayout
...
- (CGSize)collectionViewContentSize {
    ...
    return CGSizeMake(self.pageCount * CGRectGetWidth(self.collectionView.frame), CGRectGetHeight(self.collectionView.frame));
}
